...
export function getWhatsappInboxAutoReplyText() {
  return getEnv(
    "WHATSAPP_INBOX_AUTO_REPLY_TEXT",
    [
...
async function sendWhatsappTemplate(payload) {
  ...
  if (!token || !phoneNumberId) {
    console.info("WhatsApp mock mode enabled", normalizedPayload);
